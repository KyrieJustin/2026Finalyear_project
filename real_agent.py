...
class RealAgentPipeline:
    ...
    def run_inference(self, image_path, question):
        ...
        External Knowledge (Real-time Search):
        {knowledge_context}
        
        Instruction:
        Use the visual evidence from the image and the external knowledge above to answer the question.
        Correct any potential misidentification if the visual details don't match the knowledge description.
        Output the correct option directly.
        """
