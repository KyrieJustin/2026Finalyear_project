...
def search_similar_images(image_path: str):
    ...
    IMGBB_API_KEY = "dc0d0696c54e0aac637370d303242297"
    SERPAPI_API_KEY = "3fb80b0eba7555abd251b7b4f616570ea20b0c5ec90fdebb62e3b85ee6643148"
...
def get_wikipedia_description(query: str):
    ...
    def _get_wikidata_entity(qid: str, session: requests.Session):
        ...
        try:
            ...
            print(f"[错误] Wikidata 实体请求失败, QID: {qid}: {e}")
            return None
        except requests.exceptions.JSONDecodeError:
            print(f"[错误] 解析 Wikidata 的 JSON 数据失败, QID: {qid}.")
            return None
...
def get_discriminative_region(image_path: str, query: str):
    ...
    model = VisionReasonerModel(reasoning_model_path="/home/zhouzilu/FGVC-Agent/VisionReasoner-7B")
    image = Image.open(image_path).convert("RGB")
